...
function Nutriciency() {
      return (
        ...
        <div className="container" style={{backgroundColor: 'rgba(255, 255, 255, 0.2)', borderRadius: '25px'}}>
          ...
          <br />
          <img src={nutriciency_popover} alt="nutriciency" className="img-fluid"  />
          <img src={nutriciency_db} alt="nutriciency" className="img-fluid"  />
         <Typography className="body">
         <b>Background:</b>
          This was a project for my senior capstone class at JMU. Teamed with 7 people (2 frontend, 5 backend), we were tasked to create a C#/.NET web app for a local food bank.
